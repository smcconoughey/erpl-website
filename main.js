...
async function loadSocialLinks() {
    ...
    const socialIcons = {
        discord: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M7 7.5A13.5 13.5 0 0 1 12 6a13.5 13.5 0 0 1 5 1.5c1.2 2 2 4.3 2.3 6.8a11.5 11.5 0 0 1-3.6 2.1l-.9-1.2"/><path d="M7.7 14.4a8.8 8.8 0 0 0 8.6 0M7.2 15.2l-.9 1.2a11.5 11.5 0 0 1-3.6-2.1C3 11.8 3.8 9.5 5 7.5"/><circle cx="9" cy="12" r=".75" fill="currentColor" stroke="none"/><circle cx="15" cy="12" r=".75" fill="currentColor" stroke="none"/></svg>',
    ...
    if (social.discord) {
        links.push(`<a href="${social.discord}" class="social-link" target="_blank" rel="noopener">${socialIcons.discord} Discord</a>`);
    }
    if (social.linkedin) {
        links.push(`<a href="${social.linkedin}" class="social-link" target="_blank" rel="noopener">${socialIcons.linkedin} LinkedIn</a>`);
    }
    if (social.twitter) {
...
async function loadAlumniOutcomes() {
    ...
    if (data.callToAction) {
        ...
        if (ctaBtnEl) {
            ...
            ctaBtnEl.target = '_blank';
            ctaBtnEl.rel = 'noopener';
        }
    }
}
